      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="mb-8">
          ...
          <p className="text-lg text-white/60">
            El programa completo con uniforme incluido y todos los beneficios
          </p>
        </div>
        ...
        <div className="bg-zinc-900 border border-[#FA7B21]/30 rounded-lg p-6 sm:p-8 mb-8">
          <h2 className="text-xl font-semibold text-[#FA7B21] mb-4">
            ¿Qué incluye el programa de 3 meses?
          </h2>

          <ul className="space-y-3 text-white/80">
            <li className="flex items-start gap-3">
              <span className="text-[#FA7B21] mt-1">✓</span>
              <span><strong>24 clases</strong> distribuidas en 3 meses</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-[#FA7B21] mt-1">✓</span>
            ...
            <li className="flex items-start gap-3">
              <span className="text-[#FA7B21] mt-1">✓</span>
              <span>Posibilidad de graduación</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-[#FA7B21] mt-1">✓</span>
          ...
          <div className="mt-6 pt-6 border-t border-white/10">
            <div className="flex items-baseline gap-2">
              <span className="text-3xl font-bold text-[#FA7B21]">S/ 869</span>
              <span className="text-white/60">incluye uniforme</span>
            </div>
            <p className="text-sm text-white/50 mt-2">
              Ahorra S/ 121 comparado con 3 programas mensuales individuales
            </p>
          </div>
        </div>

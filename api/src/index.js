...
const consultaAsistenciaRoutes = require('./routes/consulta-asistencia');
...
const spaceProfesoresRoutes = require('./routes/space-profesores');
...
const spaceTareasRoutes = require('./routes/space-tareas');
...
app.use('/api/space/tareas', spaceAuth, spaceTareasRoutes);

...
interface RegistroTresMesesPageProps {
  onNavigateHome: () => void;
...
export function RegistroTresMesesPage({ onNavigateHome, onSuccess }: RegistroTresMesesPageProps) {
  ...
  const precioBase = 869;
  const preciosPolos = { '0': 0, '1': 60, '2': 110, '3': 150 };
  const total = precioBase + preciosPolos[polosOption];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        ...
        tallaUniforme: formData.tallaUniforme,
      ...
      const response = await fetch('https://pallium-n8n.s6hx3x.easypanel.host/webhook/programa3meses', {
        method: 'POST',
        headers: {
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="mb-8">
          <h1 className="text-white mb-2">
            Formulario de Matrícula - Programa 3 Meses
          </h1>
          <p className="text-white/60">
            Complete los siguientes datos para inscribirse en el programa completo de 3 meses
          </p>
        </div>
          ...
          <div className="border-t border-white/10 pt-6">
            <div className="bg-zinc-800/50 rounded-lg p-6 space-y-3">
              ...
              <div className="flex justify-between text-white/80">
                <span>Programa 3 Meses (incluye uniforme):</span>

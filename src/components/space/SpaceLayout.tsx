...
import {
  ...
  ChevronRight, FileSignature, BarChart3, QrCode, History, UserCheck, Trophy, Bell, Gift, MapPin, CheckSquare,
} from 'lucide-react';
...
const NAV: NavEntry[] = [
  ...
  { page: 'tareas', label: 'Tareas', icon: CheckSquare },
...
const TITLES: Record<SpacePage, string> = {
  ...
  leads: 'Leads',
  compras: 'Compras', profesores: 'Profesores', 'clases-prueba': 'Clases de prueba', referidos: 'Referidos', torneos: 'Torneos', pistas: 'Pistas de Torneo', mensajes: 'Mensajes', tareas: 'Tareas', config: 'Ajustes',
};
